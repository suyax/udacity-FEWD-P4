/*
Goal of this excerice is to make Cam's Pizzeria website run jank-free
...
function randomName() {
  ...
  var randomNumberAdj = parseInt(Math.random() * adjectivesLen);
...
var selectRandomMeat = function() {
  var meatLen = pizzaIngredients.meats.length;
  var randomMeat = pizzaIngredients.meats[Math.floor((Math.random() * meatLen))];
  return randomMeat;
};
...
// {} in for loop does not set scope, changed to fix pizza at different size
...
var resizePizzas = function(size) {
  ...
  // Simplified change size function by combine dx function,change pizzasizes and switch text size
  function changePizzaSizes(size) {
    ...
    var randomPizzas = document.querySelectorAll(".randomPizzaContainer");//use querySelectorAll instead of select one by one
