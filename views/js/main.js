...
/*
Goal of this version is to make Cam's Pizzeria website run jank-free
at 60 frames per second.

Modified by Suya Xu
*/
// this website randomly generates pizzas. Here are arrays of all possible pizza ingredients.
	...
	switch (x) {
		case "dark":
			var dark = ["dark", "morbid", "scary", "spooky", "gothic", "deviant",
				...
				"morose", "tragic", "shattered", "broken", "sad", "melancholy", "somber",
				"dark", "gloomy", "homicidal", "murderous", "shady", "misty",
				"dusky", "ghostly", "shadowy", "demented", "cursed", "insane", "possessed",
				"grotesque", "obsessed"
			];
			return dark;
		case "color":
			var colors = ["blue", "green", "purple", "grey", "scarlet", "NeonGreen",
				...
				"chestnut", "rosy", "copper", "crimson", "teal", "indigo", "navy", "azure",
		...
		case "whimsical":
			var whimsy = ["whimsical", "silly", "drunken", "goofy", "funny", "weird",
				"strange", "odd", "playful", "clever", "boastful", "breakdancing",
				"hilarious", "conceited", "happy", "comical", "curious", "peculiar",
				"quaint", "quirky", "fancy", "wayward", "fickle", "yawning", "sleepy",
				"cockeyed", "dizzy", "dancing", "absurd", "laughing", "hairy", "smiling",
		...
		case "noisy":
			var noisy = ["untuned", "loud", "soft", "shrieking", "melodious", "musical",
				...
				"yelling", "hollering", "caterwauling", "bawling", "bellowing", "roaring",
				"squealing", "beeping", "knocking", "tapping", "rapping",
				"humming", "scatting", "whispered", "whispering", "rasping", "buzzing",
		...
		case "apocalyptic":
			var apocalyptic = ["nuclear", "apocalyptic", "desolate", "atomic", "zombie",
				...
				"rotten", "deadly", "plagued", "decimated", "rotting", "putrid", "decayed",
				"deserted", "acidic"
			];
			return apocalyptic;
		case "insulting":
			var insulting = ["stupid", "idiotic", "fat", "ugly", "hideous", "grotesque",
		...
		case "praise":
			var praise = ["beautiful", "intelligent", "smart", "genius", "ingenious",
				...
				"enthusiastic", "fierce", "awesome", "radical", "tubular", "fearsome",
				"majestic", "grand", "stunning"
			];
			return praise;
		case "scientific":
			var scientific = ["scientific", "technical", "digital", "programming",
				"calculating", "formulating", "cyberpunk", "mechanical", "technological",
	...
	switch (y) {
		case "animals":
			var animals = ["flamingo", "hedgehog", "owl", "elephant", "pussycat",
				"alligator", "dachsund", "poodle", "beagle", "crocodile", "kangaroo",
				...
				"hawk", "trout", "squid", "octopus", "sloth", "snail", "locust", "baboon",
				"lemur", "meerkat", "oyster", "frog", "toad", "jellyfish",
				"butterfly", "caterpillar", "tiger", "hyena", "zebra", "snail", "pig",
				"weasel", "donkey", "penguin", "crane", "buzzard", "vulture",
				"rhino", "hippopotamus", "dolphin", "sparrow", "beaver", "moose", "minnow",
				"otter", "bat", "mongoose", "swan", "firefly", "platypus"
			];
			return animals;
		case "profession":
			var professions = ["doctor", "lawyer", "ninja", "writer", "samurai",
				...
				"plumber", "cashier", "electrician", "waiter", "president", "governor",
				"senator", "scientist", "programmer", "singer", "dancer", "director",
				"mayor", "merchant", "detective", "investigator", "navigator", "pilot",
		...
		case "fantasy":
			var fantasy = ["centaur", "wizard", "gnome", "orc", "troll", "sword",
				...
				"knight", "squire", "magician", "witch", "warlock", "unicorn", "dragon",
				"wyvern", "princess", "prince", "king", "queen", "jester",
				"tower", "castle", "kraken", "seamonster", "mermaid", "psychic", "seer",
				"oracle"
			];
			return fantasy;
		case "music":
			var music = ["violin", "flute", "bagpipe", "guitar", "symphony", "orchestra",
			...
			return music;
		case "horror":
			var horror = ["murderer", "chainsaw", "knife", "sword", "murder", "devil",
				"killer", "psycho", "ghost", "monster", "godzilla", "werewolf",
				"vampire", "demon", "graveyard", "zombie", "mummy", "curse", "death",
				"grave", "tomb", "beast", "nightmare", "frankenstein", "specter",
				"poltergeist", "wraith", "corpse", "scream", "massacre", "cannibal",
				"skull", "bones", "undertaker", "zombie", "creature", "mask", "psychopath",
		...
		case "gross":
			var gross = ["slime", "bug", "roach", "fluid", "pus", "booger", "spit",
				...
				"centipede", "beetle", "fart", "snot", "crevice", "flatulence", "juice",
				"mold", "mildew", "germs", "discharge", "toilet", "udder", "odor",
				"substance",
				"fluid", "moisture", "garbage", "trash", "bug"
			];
			return gross;
		case "everyday":
			var everyday = ["mirror", "knife", "fork", "spork", "spoon", "tupperware",
				"minivan", "suburb", "lamp", "desk", "stereo", "television", "TV",
				"book", "car", "truck", "soda", "door", "video", "game", "computer",
				"calender", "tree", "plant", "flower", "chimney", "attic", "kitchen",
				"garden", "school", "wallet", "bottle"
			];
			return everyday;
		case "jewelry":
			var jewelry = ["earrings", "ring", "necklace", "pendant", "choker", "brooch",
		...
		case "places":
			var places = ["swamp", "graveyard", "cemetery", "park", "building", "house",
				"river", "ocean", "sea", "field", "forest", "woods", "neighborhood",
				"city", "town", "suburb", "country", "meadow", "cliffs", "lake", "stream",
				"creek", "school", "college", "university", "library", "bakery",
				"shop", "store", "theater", "garden", "canyon", "highway", "restaurant",
...
var makeRandomPizza = function() {
	...
	pizza = pizza + ingredientItemizer(selectRandomSauce()) + ingredientItemizer(
		selectRandomCrust());//add sauce and crust in one step
...
var resizePizzas = function(size) {
	...
	// Simplified change size function by combine dx function,change pizzasizes and switch text size function
	function changePizzaSizes(size) { //change document.quaryselector to getElementById for better performance
		var newWidth = "33.3%";
		switch (size) {
			case "1":
				newWidth = "25%";
		...
		var randomPizzas = document.getElementsByClassName("randomPizzaContainer"); //use getElementsByClassName instead of querySelectorAll for better performance
		// Iterates through pizza elements on the page and changes their width.
		for (var i = 0; i < randomPizzas.length; i++) { //Declare randomePizzas to reduce hard code
			randomPizzas[i].style.width = newWidth;
		}
	}

	changePizzaSizes(size);//call changePizzaSizes function
...
//Declare pizzatotal to reduce hard code
var pizzaTotal = 100;
// declare pizzasDive outside loop to combine dom call
...
//optimize the updatePositions functions by define variable out of for loop
...
document.addEventListener('DOMContentLoaded', function() {
	var cols = 8;
	var s = 256;
	var row = Math.floor(window.innerHeight / 200); // Using windows innerheight to refine number of rows
	var pizzaNumber = row * cols;//reduce total number of pizzas to help performance
	var elem; //Declaring the elem variable outside the loop will prevent it from being created every time the loop is executed.
